...
public class WeirdList {
    /** Set head to make constructor. */
    private int _head;
    /** Set tail to make constructor. */
    private WeirdList _tail;

    /** Make helper class to make empty WeirdList. */
    public static class WeirdEmpty extends WeirdList {
        /**
         * constructor WeirdEmpty using super.
         * If it doesn't exist, constructor will look for WeirdList()
         * And make compiler error
         */
        public WeirdEmpty() {
            super(0, null);
        }
        ...
        public WeirdList map(IntUnaryFunction func) {
            return new WeirdEmpty();
        }
    }

    /** The empty sequence of integers. */
    public static final WeirdList EMPTY = new WeirdEmpty();
