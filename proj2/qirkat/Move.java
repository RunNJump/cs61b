...
class Move {
    ...
    static Move move(Move move0, Move move1) {
        ...
        if (move0.jumpTail() == null) {
            return move(move0._col0, move0._row0,
                    move0._col1, move0._row1, move1);
        } else {
            return move(move0._col0, move0._row0, move0._col1,
                    move0._row1, move(move0._nextJump, move1));
        }
     ...
     *  the left. */
    boolean isLeftMove() {
        return _col0 - 1 == _col1 && _row0 == _row1;
    }

    /** Return true iff this is a horizontal, non-capturing move
     *  to the right. */
    boolean isRightMove() {
        return _col1 - 1 == _col0 && _row0 == _row1;
    }
    ...
    private void toString(Formatter out) {
        ...
        while (_nextJump != null) {
            out.format("-%c%c", _nextJump._col1, _nextJump._row1);
            _nextJump = _nextJump.jumpTail();
        }
    }
