...
public class Game {
    ...
    /**
     * It get input key from user.
     * @param key is user input.
     * @return Side to move.
     */
    ...
    private Tile getValidNewTile() {
        Tile newTile = _source.getNewTile(Main.BOARD_SIZE);
        while (_model.tile(newTile.col(), newTile.row()) != null) {
            newTile = _source.getNewTile(Main.BOARD_SIZE);
        }
        return newTile;
    }
