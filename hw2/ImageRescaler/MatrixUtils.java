 ...
 *
 *  @author Josh Hug and Hong Seok Jang
 */
...
public class MatrixUtils {
    ...
    /**Make a helper function for accumulateVertical.
     * @param e input 2D int array
     * @param r row of 2D int array
     * @param c col of 2D int array
     * @return return proper(smallest) value to add current position.
     */

    public static double get(double[][] e, int r, int c) {
        if (c == 0) {
            if (e[r - 1][c + 1] > e[r - 1][c]) {
                return e[r - 1][c];
            } else {
                return e[r - 1][c + 1];
            }
        ...
        if (c == e[0].length - 1) {
            ...
            return java.lang.Math.min(java.lang.Math.min(e[r - 1][c - 1], e[r - 1][c]), e[r - 1][c + 1]);
        }
    }
    ...
    /** Make a helper function for accumulate.
     * @param m Input vertical double 2d array
     * @return double 2d array n that was rotate m in clockwise
     */
    ...
    public static double[][] accumulate(double[][] m, Orientation orientation) {
        if (orientation == Orientation.VERTICAL) {
            ...
            return accumulateVertical(rotate(m));
        }
    }
