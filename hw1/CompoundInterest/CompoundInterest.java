...
public class CompoundInterest {
    ...
    static double futureValue(double presentValue, double rate,
                              int targetYear) {
        return presentValue * java.lang.Math.pow(1 + 0.01 * rate, numYears(targetYear));
    }
    ...
    static double futureValueReal(double presentValue, double rate,
        ...
        return futureValue(presentValue, rate, targetYear) * java.lang.Math.pow((1 - 0.01 * inflationRate), numYears(targetYear));
    }
    ...
    static double totalSavings(double perYear, int targetYear, double rate) {
        double result = 0;
        for (int i = 0; i < numYears(targetYear) + 1; i++) {
            result += perYear * java.lang.Math.pow(1 + 0.01 * rate, i);
        }
        return result;
    }
    ...
    static double totalSavingsReal(double perYear, int targetYear, double rate,
        ...
        double result = 0;
        for (int i = 0; i < numYears(targetYear) + 1; i++) {
            result += perYear * java.lang.Math.pow(1 + 0.01 * rate, i) * java.lang.Math.pow(1 - 0.01 * inflationRate, i);
        }
        return result;
    }
